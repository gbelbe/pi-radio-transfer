...
# Title: Tx Top
# Generated: Sun Apr  9 19:13:49 2017
##################################################
...
class tx_top(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/gbelbe/Develop/pi-radio-transfer/src/gnuradio/test_src_file.txt', False)
