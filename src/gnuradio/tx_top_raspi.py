...
# Title: Tx Top Raspi
# Generated: Wed Apr 26 22:28:28 2017
##################################################
...
class tx_top_raspi(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Top Raspi")
...
def main(top_block_cls=tx_top_raspi, options=None):
