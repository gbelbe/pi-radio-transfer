...
# Title: Channel Model
# Description: Multipath, frequency and timing errors simulation
# Generated: Sat Apr 29 20:05:43 2017
##################################################
...
class channel_model(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rx_frequency_error = rx_frequency_error = 200
        ...
        self.connect((self.channels_fading_model_0, 0), (self.channels_sro_model_0, 0))    
        self.connect((self.channels_sro_model_0, 0), (self.blocks_complex_to_float_0, 0))    
        self.connect((self.channels_sro_model_0, 0), (self.qtgui_const_sink_x_0, 0))    
        self.connect((self.channels_sro_model_0, 0), (self.qtgui_time_sink_x_0, 0))    
    ...
    def set_sound_card_sample_rate(self, sound_card_sample_rate):
        ...
        self.channels_sro_model_0.set_samp_rate(self.sound_card_sample_rate)
