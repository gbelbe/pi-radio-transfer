...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.rational_resampler_base_xxx_0_0 = filter.rational_resampler_base_fff(1, sound_card_sample_rate/symbol_rate, (variable_rrc_filter_taps))
        self.rational_resampler_base_xxx_0 = filter.rational_resampler_base_fff(sound_card_sample_rate/symbol_rate, 1, (variable_rrc_filter_taps))
        ...
        self.analog_agc2_xx_0 = analog.agc2_ff(symbol_rate, symbol_rate/1000, 1.0, 1.0)
        self.analog_agc2_xx_0.set_max_gain(65536)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_agc2_xx_0, 0), (self.qtgui_time_sink_x_1_1, 0))    
        self.connect((self.analog_agc2_xx_0, 0), (self.rational_resampler_base_xxx_0_0, 0))    
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.rational_resampler_base_xxx_0, 0))    
        ...
        self.connect((self.rational_resampler_base_xxx_0, 0), (self.blocks_throttle_0, 0))    
        self.connect((self.rational_resampler_base_xxx_0, 0), (self.qtgui_time_sink_x_0, 0))    
        self.connect((self.rational_resampler_base_xxx_0_0, 0), (self.blocks_threshold_ff_0, 0))    
